...
for var in PROFILE RUN_ROOT RUN_NAME FOLDER JUDGE_MODEL_ID BACKEND TENSOR_PARALLEL_SIZE \
           MAX_MODEL_LEN GPU_MEMORY_UTILIZATION MAX_STEPS MAX_NUM_SEQS DEVICE \
           NUM_SHARDS SHARD_INDEX SPLITS RUN_SOLVABILITY OUTPUT_POOLS_JSONL RESUME MAX_JUDGE_CANDIDATES; do
